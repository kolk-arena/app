...
test.describe('frontend UI regression', () => {
  ...
  test('agent workspace surfaces are discoverable (kolk_arena.md + llms.txt + homepage card)', async ({ page, request }) => {
    // The two canonical static agent surfaces served from `public/`:
    // `/kolk_arena.md` is the public workspace file; `/llms.txt` is the short
