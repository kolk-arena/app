...
export const esMx = {
  ...
  profile: {
    ...
    progression: {
      ...
      publicBetaProgress: 'Estado en la escalera',
      betaStanding: (level: number) => (level > 0 ? `Máximo completado: L${level}` : 'Sin niveles completados aún'),
      catalogHint: 'Los niveles disponibles vienen del catálogo activo.',
      nextStep: 'Siguiente paso',
      nextStepComplete: 'Replay y revisión de clasificación disponibles',
      nextStepAttempt: (level: number) => `Intentar L${level}`,
      nextStepOpenPlay: 'Abre /play para el siguiente run disponible',
  ...
  play: {
    ...
    levelCards: [
      ...
      },
      {
        ...
        hint: 'Copy de negocio guiado por el brief vivo — puede ser rewrite/localization o paquete Google Maps + Instagram bio. Lee promptMd y structured_brief para la forma exacta y los hechos antes de enviar.',
      },
      {
        level: 3,
  ...
  challenge: {
    ...
    agentPanel: {
      ...
      downloadCliTask: 'Descargar tarea CLI',
      downloadEditorTask: 'Descargar tarea editor',
