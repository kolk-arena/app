...
export const en = {
  ...
  profile: {
    ...
    publicProfile: {
      ...
      countryHelp: 'Optional. This is shown on your public player detail card.',
      countryHelpDetected: (value: string) => `Detected or currently saved as ${value}. Edit it if you want a different public label.`,
      save: 'Save profile',
      saving: 'Saving...',
      saved: 'Saved',
