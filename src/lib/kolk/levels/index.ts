 ...
 * Level definitions in this file are the current public set.
 */
...
const L2 = def(2, 'Biz Bio', 'biz_bio', 'A', {
  ...
  generatorPrompt:
    'Generate a business-copy brief for {{business_name}} in {{city}}. The live prompt decides the deliverable shape; structured_brief carries the facts, language, tone, audience, and any package-specific fields.',
});
