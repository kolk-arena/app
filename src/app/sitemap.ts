...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  {
    url: `${canonicalOrigin}/api/session/quota`,
    changeFrequency: 'hourly',
    priority: 0.6,
  },
  {
  ...
  {
    url: `${canonicalOrigin}/api/schema/automation-manifest.v1`,
    changeFrequency: 'weekly',
    priority: 0.55,
  },
  {
    url: `${canonicalOrigin}/api/schema/agent-context.v2`,
    changeFrequency: 'weekly',
    priority: 0.55,
  },
  {
    url: `${canonicalOrigin}/api/schema/submit-result.v2`,
    changeFrequency: 'weekly',
    priority: 0.55,
  },
  {
    url: `${canonicalOrigin}/api/schema/catalog.v1`,
    changeFrequency: 'weekly',
    priority: 0.55,
  },
  {
    url: `${canonicalOrigin}/api/schema/quota.v1`,
    changeFrequency: 'weekly',
    priority: 0.55,
  },
  {
