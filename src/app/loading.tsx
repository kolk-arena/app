  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <section className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="h-8 w-40 animate-pulse rounded-md border border-slate-200 bg-slate-200" />
        <div className="h-14 w-full max-w-3xl animate-pulse rounded-md border border-slate-200 bg-slate-200" />
