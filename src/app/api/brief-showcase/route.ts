...
const FALLBACK_REQUESTS: Record<'en' | 'es-mx' | 'zh-tw', ShowcaseRequest[]> = {
  en: [
    ...
    },
    {
      ...
      requesterRole: 'Studio Owner',
      requestContext: 'An advisory studio has strong referrals but weak positioning, and the owner needs the profile cleaned up before a sales call. Budget is $180. It needs to explain who the studio helps, what it offers, and why the service feels trustworthy.',
    ...
    },
    {
      ...
      requestContext: 'A SaaS team has messy draft notes about a billing change and support is already getting confused tickets. Budget is $220. They need customer-facing support copy that is calm, precise, and easy to scan.',
